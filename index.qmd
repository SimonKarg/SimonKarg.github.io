...
Hi, my name is Simon. I'm an assistant professor at [Aarhus University](https://pure.au.dk/portal/da/persons/simon-tobias-schulz-karg(535467e3-c79a-4be4-aa51-1192cc38be7a).html){target="_blank"}. I'm also a dad and rock climbing enthusiast. Here are some more things about me:
...
-   I love R. I'm always eager to learn new things about R, new packages, ways to be creative, analyzing data. Above all, I love visualizing data. I've also taught a PhD level course on advanced R. All my slides and materials are freely available over [here](https://simonkarg.github.io/advanced_r_course/){target="_blank"}.
